      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12">
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Don&apos;t miss these exciting street food gatherings and festivals
          </p>
        </div>

        <Button
          asChild
          className="mt-4 md:mt-0 bg-primary hover:bg-orange-700 text-white"
        >
          <Link href="/events">
          ...
          >
            <div className="relative h-48">
              ...
              <div className="absolute top-2 right-2">
                <Badge
                  className={event.isFree ? "bg-green-600" : "bg-blue-600"}
                >
