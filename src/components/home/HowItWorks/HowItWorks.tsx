    ...
    <section className="" id="how-it-works">
      <div className="container mx-auto">
        <div className="text-center mb-12">
          <TextSizer
            title="How It Works"
            desc="Discover, share, and enjoy the best street food spots in your city"
          />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
          <Card className="border-0 hover:shadow-primary cursor-pointer shadow-md duration-500 transition-shadow">
            <CardContent className="pt-6">
              ...
              <p className="text-muted-foreground text-center">
                Browse through hundreds of street food spots, filter by
                category, price range, or search by name.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-0  shadow-md  transition-shadow hover:shadow-primary duration-500 cursor-pointer">
            <CardContent className="pt-6">
              ...
              <p className="text-muted-foreground text-center">
                Post your favorite street food discoveries with photos,
          ...
          <Card className="border-0 hover:shadow-primary cursor-pointer shadow-md duration-500  transition-shadow">
            <CardContent className="pt-6">
              ...
              <p className="text-muted-foreground text-center">
                Vote, comment, and rate food spots to help others find the best
          ...
          <Card className="border-0 hover:shadow-primary cursor-pointer shadow-md duration-500  transition-shadow">
            <CardContent className="pt-6">
              ...
              <p className="text-muted-foreground text-center">
                Subscribe to unlock exclusive premium food spots not available
                to regular users.
              </p>
            </CardContent>
          </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-muted-foreground">
                Share details about your favorite street food vendor including
                photos, location, and price.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-muted-foreground">
                Our admins review your submission to ensure quality and accuracy
                before publishing.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-muted-foreground">
                Once approved, your food spot goes live for everyone to discover
                and enjoy!
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            <div className="flex items-start p-4 bg-white rounded-lg shadow">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-muted-foreground">
                  Access hidden gems and exclusive street food locations
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start p-4 bg-white rounded-lg shadow">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-muted-foreground">
                  Discover food spots marked as premium by our admins
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start p-4 bg-white rounded-lg shadow">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-muted-foreground">
                  Get access to special discounts and offers from vendors
                </p>
              </div>
            </div>
